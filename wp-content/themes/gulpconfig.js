...
// Project paths
var project     = 'rst-wp',               // The directory name for your theme; change this at the very least!
    src         = 'src/',               // The raw material of your theme: custom scripts, SCSS source files, PHP files, images, etc.; do not delete this folder!
    build       = 'rst_build/',         // A temporary directory containing a development version of your theme; delete it anytime
    dist        = ''+project+'/',       // The distribution package that you'll be uploading to your server; delete it anytime
...
module.exports = {
  ...
  browsersync: {
    ...
    proxy: 'rst-wp.lc', // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
    watchOptions: {
